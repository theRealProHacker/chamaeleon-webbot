...
- deine Agenturnummer,
- dein Passwort,
- gegebenenfalls deine personalisierte E-Mail-Adresse.

### Ich habe mein Passwort vergessen. Wie kann ich es zurücksetzen?

Klicke oben rechts auf **MeinChamäleon** und wähle den **Login für Reisebüros** aus. Klicke im passenden Login-Bereich auf **Passwort setzen**.

Trage anschließend deine Agenturnummer und deine E-Mail-Adresse ein. Du erhältst dann eine E-Mail mit einem Link, über den du dein Passwort selbst setzen kannst.
...
Die Provision wird automatisch nach Buchungseingang überwiesen, sobald der Gast die Anzahlung geleistet hat.

Wenn sich der Reisepreis nachträglich durch Zusatzleistungen erhöht, wird die zusätzliche Provisionsdifferenz bei Abreise ausgezahlt. Das kann zum Beispiel bei einem Anschlussprogramm, einer Versicherung oder einem Flug-Upgrade der Fall sein.
...
Wenn Chamäleon den Gästen in solchen Fällen **100 % des Reisepreises** erstattet, muss auch die Provision an Chamäleon zurückgezahlt werden.

Bei individuellen Fällen wende dich bitte an das Vertriebsteam.
...
### Welche Deko erhalte ich kostenfrei?

Du kannst kostenfreie Schaufenster-Deko zur Verkaufsunterstützung bestellen.

Kostenfrei verfügbar sind unter anderem:

- das knallgelbe Jubiläumspaket mit Stickern, Deckenhängern und Herzaufsteller im XL-Format,
...
Die **Kataloge der Herzen** kannst du kostenfrei bestellen.
...
- **Europa-Katalog:** Reisen innerhalb Europas
- **Fernreise-Katalog:** Reisen nach Afrika, Amerika, Asien und Ozeanien

### Wo finde ich das Schaufensterangebot für eine bestimmte Reise?

Für jede Reise kannst du kostenfrei ein Schaufensterangebot als PDF herunterladen.

So gehst du vor:

1. Öffne die gewünschte Reise.
2. Gehe zur Übersicht der Reise.
3. Klicke auf **Schaufensterangebot erstellen**.
...
Die lichtdurchlässigen Stoffbanner werden mit einer Kordel geliefert. Mit dieser Kordel kannst du das Banner befestigen.

---

## 5. Expi-Ermäßigung

### Wie viel Ermäßigung erhalte ich als Expi?

Als aktiver Reiseprofi am Counter erhältst du grundsätzlich **30 % Ermäßigung auf das Landprogramm**. Deine Begleitung erhält grundsätzlich **20 % Ermäßigung auf das Landprogramm**.
...
Um dir einen Platz auf deiner Wunschreise zu sichern, kannst du im Agenturbereich eine Reservierung anlegen.

Wichtig: Vermerke bei der Reservierung, dass es sich um deine eigene Expi-Buchung handelt.

Die Erlebnisberater*innen senden dir anschließend eine aktualisierte Reiseanmeldung mit dem finalen Reisepreis zu.
...
Die Expi-Ermäßigung gilt für aktive Reiseprofis am Counter.
...
## 6. Buchungen, Optionen und Reservierungen

### Wie kann ich eine Buchung oder Option anlegen?

Du kannst Reisen direkt auf der Chamäleon-Website buchen oder reservieren.

So gehst du vor:

1. Wähle die gewünschte Reise aus.
2. Öffne den Reiter **Termine & Preise**.
3. Wähle den passenden Termin aus.
...
Eine Option wird **7 Tage** gehalten. Danach wird sie automatisch in eine Festbuchung umgewandelt.

Vor Ablauf der 7 Tage erhältst du eine Erinnerung per E-Mail.

Du kannst deine Optionen im Agenturbereich innerhalb der 7 Tage selbst:

- stornieren,
- fixieren,
- in eine Festbuchung umwandeln.
...
- **Fixieren**, wenn daraus eine Festbuchung werden soll,
- **Stornieren**, wenn die Option gelöscht werden soll.

### Wann erscheinen die Termine für eine bestimmte Reise?
...
„Jetzt vorausbuchen“ bedeutet, dass du schon jetzt Plätze für die Wunschreise deiner Kundinnen und Kunden sichern kannst.

Bis spätestens **10 Monate vor Abreise** erhältst du von Chamäleon ein unverbindliches Angebot. Danach entscheidest du, ob du die Reise fest buchen möchtest.

Wichtig: „Jetzt vorausbuchen“ bedeutet **nicht**, dass ein Katalog vorbestellt wird.
...
## 7. Paxlounge, BOSYS und Midoffice
...
### Die Übertragung zur Paxlounge funktioniert nicht. Was kann ich tun?

Bitte prüfe zuerst diese Punkte:

1. Ist deine Agenturnummer korrekt hinterlegt?
...
Wenn die Übertragung für dein Reisebüro noch nicht freigeschaltet ist, meldet sich das Vertriebsteam zeitnah bei dir.

---

## 8. Gästedaten, Unterlagen und Agenturdaten

### Wo kann ich die Daten meiner Gäste einsehen?

Die Daten deiner Gäste findest du im Agenturbereich unter **Gästedaten**.

### Wo finde ich die Unterlagen für die Gäste?
...
Wenn du dein Logo neu hinterlegen oder ändern möchtest, sende es bitte als **JPG- oder PNG-Datei** an das Vertriebsteam.

E-Mail: agentur@chamaeleon-reisen.de

---

## 9. Neue Agenturen und Zusammenarbeit mit Chamäleon

### Ich möchte mich als neue Agentur registrieren. Welche Konditionen gelten?

Bitte wende dich an das Vertriebsteam. Dort werden alle Details zur Zusammenarbeit und zu den Konditionen besprochen.

E-Mail: agentur@chamaeleon-reisen.de  
Telefon: +49 30 347 996 290

### Wie kann ich mich als neue Agentur registrieren?
...
### Was passiert, wenn mein Gast selbst eine Buchung anlegt?

Wenn dein Gast sich bei **MeinChamäleon** einloggt und selbst eine Buchung anlegt, wirst du informiert.
...
### Welche Reisen kann ich als Just4You buchen?
...
## 11. Reisen von Chamäleon auf eigener Website einbinden
...
## 13. Inforeisen, Famtrips und LiveStreams

### Bietet Chamäleon Inforeisen oder Famtrips an?

Wenn du dich für eine Inforeise oder einen Famtrip interessierst, wende dich bitte an das Vertriebsteam.

E-Mail: agentur@chamaeleon-reisen.de  
Telefon: +49 30 347 996 290

Hinweis: Reiseprofis können das Chamäleon-Gefühl auch über die Expi-Ermäßigung kennenlernen. Informationen dazu findest du im Agenturbereich.
...
## 14. Community für Reiseprofis

### Gibt es eine eigene Facebook-Gruppe für Reiseprofis?

Ja. Es gibt die Facebook-Gruppe **Chamäleon Insider** für Reiseprofis.
