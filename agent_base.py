...
def format_system_prompt(
    ...
    if is_kunde:
        ...
        kunden_modus_block = (
            ...
            "abgerufenen Flugdaten dieses Kunden nennen — vergangene wie "
            "kommende.\n"
            "- Andere Konto- und Buchungsdaten (Rechnung, Dokumente, Passdaten "
            "der Teilnehmer) kannst du selbst nicht abrufen oder ändern; zeige "
            "dem Kunden stattdessen den passenden MeinChamäleon-Link (siehe "
            "unten), auf dem er sie selbst einsehen oder ergänzen kann. Nur für "
            "echte Vorgänge wie Umbuchung oder Stornierung, für die es keine "
            "solche Seite gibt, verweise an den Erlebnisberater.\n"
